public class Constants {
    ...
    public static final long SIMULATION_REPETITIONS = 3;
    public static final double DELTA_T = 1;
    public static final double b = 1;
    public static final double PARTICLE_MAX_RADIUS = 1;
    public static final double PARTICLE_MIN_RADIUS = 0.5;
